...
public class Odometer extends Thread {
  ...
  public void run() {
    ...
    while (true) {
      ...
      distL = Math.PI * LocalizationLab.WHEEL_RADIUS * (nowTachoL - lastTachoL) / 180; // Displacement
      ...
      deltaT = (distL - distR) / LocalizationLab.TRACK;// Change in Theta, 14.7 is wheelbase
